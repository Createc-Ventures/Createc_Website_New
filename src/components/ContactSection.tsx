    ...
    <section id="contact" className="section-padding relative bg-black">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-stretch bg-[#242124] rounded-xl backdrop-blur-md shadow-xl overflow-hidden">
            {/* Contact Info */}
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@createc.in" className="text-white hover:text-gray-200 transition-colors">info@createc.in</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+917057731716" className="text-white hover:text-gray-200 transition-colors">+91 7057731716</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://www.createc.in" className="text-white hover:text-gray-200 transition-colors">www.createc.in</a>
                  </div>
                </div>
                ...
                <div className="flex space-x-4">
                  {['facebook', 'twitter', 'instagram', 'linkedin'].map((social, index) => (
                    <a 
                      key={index}
                      href="#" 
                      className="w-10 h-10 rounded-full bg-white bg-opacity-20 flex items-center justify-center hover:bg-opacity-40 transition-colors"
                    >
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-3 bg-white/10 backdrop-blur-md  border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-createc-purple text-white"
