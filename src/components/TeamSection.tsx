  ...
  const team = [
    {
      ...
      description:
        "Tech visionary with expertise in emerging technologies and software solutions.",
    },
    {
      name: "Ranjit Dhoran",
      role: "Co-Founder & CEO",
    ...
    },
    {
      ...
      image:
        "https://images.squarespace-cdn.com/content/v1/5e335c197ce81d501c607a07/43a23995-70da-44ce-a4cb-a37df62aea6c/male-professional-headshot-tips-mens-corporate-headshots-guide.jpg",
      description:
        "Marketing expert with a creative approach to brand development and strategy.",
    },
  ];
    ...
    >
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-createc-blue mb-2">
            Meet the Leadership
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {team.map((member, index) => (
            <div
              ...
              hover:scale-105
              hover:shadow-[0_0_25px_rgba(103,84,255,0.7)]
              hover:animate-pulse"
            ...
            >
              <div className="relative h-72 overflow-hidden rounded-t-xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-createc-blue/70 to-transparent opacity-0 hover:opacity-60 transition-opacity duration-500 rounded-t-xl"></div>
              </div>

              <div className="p-6 text-gray-900">
                <h3 className="font-montserrat font-bold text-xl text-createc-blue">
                  {member.name}
                </h3>
                ...
                <div className="mt-4 flex space-x-3">
                  ...
                  <a
                    href="#"
                    className="w-8 h-8 rounded-full bg-white flex items-center justify-center hover:bg-createc-blue hover:text-white transition-colors"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="currentColor"
      ...
      {/* Background elements */}
      <div className="absolute top-0 right-0 w-1/4 h-1/4 bg-createc-purple opacity-10 rounded-bl-full"></div>
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-createc-blue opacity-10 rounded-tr-full"></div>
    </section>
  );
};
