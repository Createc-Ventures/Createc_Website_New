...
const projects = [
  {
    ...
    category: "Technology",
    longDescription: "We provided Morex Asset Management with Website Development, Salesforce Integration, and CRM Optimization. Our team delivered a responsive, high-performance website aligned with their premium brand identity. Seamless Salesforce and CRM integration streamlined lead management and sales workflows, enhancing operational efficiency and client engagement.",
    demoUrl: "https://www.morexasset.com/",
...
const morex = () => {
  ...
  {[
    "/assets/img/Morex/1.png",
    "/assets/img/Morex/2.jpg",
    "/assets/img/Morex/4.jpg",
    "/assets/img/Morex/3.png",
    "/assets/img/Morex/5.png",
    "/assets/img/Morex/6.jpg",
